    ...
    public partial class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            await _emailSender.SendEmailAsync(
                ...
                $"Lütfen <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>buraya tıklayarak</a> doğrulamayı yapınız.");

            StatusMessage = "Doğrulama e-postası gönderildi. Lütfen e-postalarınızı kontrol ediniz.";
            return RedirectToPage();
        }
    }
}
